...
const Pitch = () => {
  ...
  return (
    <section className="w-full min-h-screen md:mt-14 mt-2">
      <div className="w-full lg:px-24 px-2">
        <div className="w-full lg:h-[80vh] md:h-[70vh] h-[50vh] lg:bg-black md:bg-black bg-black relative rounded-2xl">
          ...
          <div className="absolute w-full left-[0%] top-[30%] flex items-center flex-col justify-center">
            <h1 className="text-white lg:text-5xl md:text-4xl text-2xl font-bold font-grotesque">
              Pitch Development
            </h1>
            <Button
              name="Book a session"
            ...
            <div className="w-full lg:h-full md:h-auto flex items-start md:mt-10 mt-10 justify-center">
              <div className="flex flex-col space-y-4 md:w-[80%] w-full">
                <div className="flex flex-col space-y-6 mb-6">
                  <h1 className="md:text-3xl text-xl text-black md:w-[70%] w-full font-bold text-left font-grotesque">
                    Crafting Compelling Pitches for Success
                  </h1>
                  <p className="text-subtext font-sfprodisplay text-md text-left w-[100%]">
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 gap-2">
            {pitch.map((item, idx) => (
              ...
              >
                ...
                <p className="text-xs text-subtext font-sfprodisplay">{item.descr}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="w-full h-full grid md:grid-cols-2 grid-cols-1 gap-8">
            ...
            <div className="w-full h-full flex items-start lg:mt-8 md:mt-2 mt-10 justify-center">
              <div className="flex flex-col space-y-4 w-[100%]">
                <div className="flex flex-col space-y-6 mb-6">
                  <h1 className="md:text-2xl text-xl text-black font-bold text-left font-grotesque md:w-[60%] w-full">
